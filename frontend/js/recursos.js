...
const API_URL = "https://your-api-url.com" // Declare API_URL here
const checkAuth = async () => {
  // Implement checkAuth function here
  return { nombre: "John Doe", rol: "ADMIN" } // Example return value
}
const getStatusBadgeClass = (status) => {
  // Implement getStatusBadgeClass function here
  switch (status) {
    case "Activo":
      return "bg-success"
    case "Dañado":
...
const showSuccess = (message) => {
  // Implement showSuccess function here
  alert(message)
}
const showError = (message) => {
  // Implement showError function here
  alert(message)
}
